...
import com.kinikumuda.multikurir_driverapp.Adapter.ChatAdapter
import com.kinikumuda.multikurir_driverapp.Constrants.AppConstants
import com.kinikumuda.multikurir_driverapp.Model.*
...
//        var intent = getIntent()
        var userId = intent.getStringExtra(AppConstants.USER_ID).toString()
        var userName = intent.getStringExtra(AppConstants.USER_NAME).toString()
        ...
        reference!!.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
               ...
               val user = snapshot.getValue(RiderModel::class.java)
